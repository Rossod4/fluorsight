...
- **(b)** ~~keep £250 and say explicitly *"we model at £250, which is **29% below** the only published UK figure (£350, EIA to the Environmental Audit Committee, May 2025), so our savings estimate is deliberately conservative."*~~ 🔴 **WITHDRAWN 4 Aug.** The EIA evidence is a **soil** figure and explicitly excludes water, so £350 is not a benchmark for our use case and £250 is not "conservative" relative to it. Say instead: *"£250 is an assumption. No UK laboratory we approached publishes a rate card — we asked seven — and we do not know whether £250 is high or low. Break-even is £62.50, so the model is four times more sensitive to lab price than to escalation rate."*
...
**£250 is an assumption, and we say so.** The only published UK figure we found is **£350 per PFAS *soil* sample** (Environmental Industries Association evidence PFAS0121 to the Environmental Audit Committee, May 2025) — and that evidence **explicitly excludes water**, so it is not a benchmark for our use case and £250 is not "conservative relative to it". We do not know whether £250 is high or low. No UK laboratory publishes a public rate card — we checked the published pricing of seven providers and all quote on request. Break-even is £62.50/sample, so the model is roughly **four times more sensitive to lab price than to escalation rate** — which makes getting one real quote our highest-value outstanding action.

> ⚠️ **Do not say "29% below the published figure" or "deliberately conservative".** That framing treats a soil price as a water benchmark and was removed on 4 Aug.

**Q2. "Your dye barely binds β-cyclodextrin. How can a displacement assay work?"**
**We already changed it — in June, and not because of the paper.** Sueishi et al. put 1,8-ANS at only ~50–195 M⁻¹ against 80–11,700 M⁻¹ for the 2,6 isomer, **across the hosts they tested** (several cyclodextrins plus cucurbit[7]uril — do not attribute either range to β-CD alone), so we switched to **2,6-ANS** on binding grounds. A paper published on **17 July 2026** in *J. Incl. Phenom. Macrocycl. Chem.*, comparing both isomers across all three native cyclodextrins, then independently confirmed it — 1,8-ANS prefers **γ**-CD, 2,6-ANS binds **β**-CD best. So the sequence is: we made the call, and the literature caught up a month later.

> Say it in that order. "We switched in June and a July paper confirmed it" is a much stronger answer than "a paper came out and we responded" — and it is the true one.
...
Mostly it cannot — the 2025 Nature Communications on-site sensor has an LOD of ~45 µg/L, 455× above the limit; the leading commercial field kit (FREDsense) is 10× above it. The best cyclodextrin array reaches 31–38 ng/L, below the limit, but it is a ~300× outlier and we do not assume we will match it. What partly bridges the gap is **preconcentration**: drawing 250 mL through the cartridge and reading against ~1 mL of retained volume is roughly **250×**, and a 1 L protocol reaches ~2,000×. At 250×, the 0.1 µg/L guideline arrives at the detector as ~25 µg/L — inside the published fluorescence span only at its bright end. AFFF source zones (10 µg/L to mg/L) are reachable today; drinking water at the guideline is not. And fundamentally we do not need to *measure* the limit — we need to **rank** samples well enough to decide which go to the lab.

> ⚠️ **Never say ~500,000×.** That figure describes waste-volume reduction in Cyclopure's water-*treatment* line, not analytical preconcentration. It is a category error and it was removed everywhere on 3–4 Aug. The correct numbers are ~250× and ~2,000×.
