...
- **Necessary regardless:** DEXSORB's role in the architecture is **preconcentration**, not just hosting. Cyclopure claims up to ~500,000× concentration. Preconcentration, not dye affinity, is what plausibly bridges the sensitivity gap in the table above — and it is a step every one of those academic sensors lacks. Lead with this.
